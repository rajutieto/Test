             ...
             if(checkBox1.Checked = true && checkBox2.Checked == true)
                {
                    ...
                    if (cb_enthalpy_or_humidity_input.SelectedIndex == 0)
                    {
                        ...
                        F1.SetNodeForDeviceUsingTempAndHum(source, name, label, btnColor.BackColor, cbItemSelected, 20, device_instance, deviceIP, temp_param_id, second_param_id, "temp", "hum", temp_present_value, second_present_value);
                    ...
                    else
                    {
                        ...
                        F1.SetNodeForDeviceUsingTempAndHum(source, name, label, btnColor.BackColor, cbItemSelected, 20, device_instance, deviceIP, temp_param_id, second_param_id, "temp","enthalpy", temp_present_value, second_present_value);
